...
function generate_model_diagram_svg(model_diagram_json) {
  ...
  function drawEntireNodeExpanded(nodePathShape, maxLengthAttribute, node) {
    ...
    //.attr('xlink:href', 'http://www.sapo.pt', '_blank')
      ...
      .attr('rx', '1')
      .attr('ry', '1')
      //.attr('onclick', 'http://www.google.pt')
      .attr('width', '10')
      .attr('height', '10')
      .style('fill', 'blue')
      ...
      .on('click', function(d) { clickGitSource(node) } );
  ...
  function nodeDoubleClicked(node) {
    ...
    if (node.attributes !== null) {
      ...
      if ($("text." + node.name + "AttributeText").length < 1) {
        ...
        console.log("Max-Length:" + maxLengthAttribute)
 ...
 var force =
  ...
  if (localStorage.getItem("savedGraph"))  {
    console.log("Laden aus local storage");
    var savedGraph = JSON.parse(localStorage.getItem("savedGraph"));
    
    force
      .nodes(savedGraph.nodes)
      .links(savedGraph.links)
  } else {
    console.log("Laden von neu");
    force =
      d3.layout.force()
      .nodes(d3.values(nodes))
      .links(links)
  ...
  */
  ...
  function tick() {
    ...
    path.attr("d", function(d) {
      ...
      if(d.source.attributes) {

        if(d.source.expanded) {

          var sourceCenter = {};
          sourceCenter.y = d.source.y + (heightSource / 2);
          sourceCenter.x = d.source.x;
          
          var newSource = calculateLine(sourceCenter, d.target, widthSource, heightSource);
          return "M " +
            newSource.x + "," +
            (newSource.y -5) + "A" +
            dr + "," + dr + " 0 0,1 " +
        ...
        if(d.target.expanded && !d.source.expanded) {
          
          var targetCenter = {};
          targetCenter.y = d.target.y + (heightTarget / 2);
          targetCenter.x = d.target.x;

          var newTarget = calculateLine(targetCenter, d.source, widthTarget, heightTarget);
    ...
    savedGraph.nodes = d3.values(nodes);
    
    savedGraph.links = links;
  ...
  function calculateHeight(node) {
    if(node.expanded) {
      return (node.attributes.length * 21 + 30);
    } else {
      return 50;
    }
  }
  ...
  function calculateWidth(node) {
    if(node.attributes) {
      ...
      return expandedWidth(maxLengthAttributeSource) + 125;
    } else {
...
var model_diagram_json = { "models": { "nodes": [{ "name": "Auth::RefreshToken", "shape": "Mrecord", "fillcolor": null, "fontcolor": null, "attributes": [["updated_at", "Timestamp without time zone"], ["user_id", "Integer"], ["token", "Character varying"], ["ip_address", "Inet"], ["user_agent", "Character varying"], ["last_used_at", "Timestamp without time zone"], ["created_at", "Timestamp without time zone"], ["id", "Integer"]], "description": [] }, { "name": "DeletedUser", "shape": "Mrecord", "fillcolor": null, "fontcolor": null, "attributes": [["location", "Character varying"], ["origin_id", "Integer"], ["origin_created_at", "Timestamp without time zone"], ["origin_updated_at", "Timestamp without time zone"], ["email", "Character varying"], ["password_digest", "Character varying"], ["first_name", "Character varying"], ["last_name", "Character varying"], ["gender", "Integer"], ["avatar_file_name", "Character varying"], ["avatar_content_type", "Character varying"], ["avatar_file_size", "Integer"], ["avatar_updated_at", "Timestamp without time zone"], ["height", "Numeric"], ["weight", "Numeric"], ["weight_unit", "Integer"], ["height_unit", "Integer"], ["birthday", "Date"], ["email_confirmed_at", "Timestamp without time zone"], ["locale", "Character varying"], ["registration_country", "Character varying"], ["application_source", "Integer"], ["platform_source", "Integer"], ["created_at", "Timestamp without time zone"], ["updated_at", "Timestamp without time zone"], ["emails_allowed", "Boolean"], ["about", "Text"], ["measurement_system", "Integer"], ["sanitized_email", "Character varying"], ["time_zone", "Character varying"], ["id", "Integer"]], "description": ["Desch isch a tescht", "ischisch"] }, { "name": "Event", "shape": "Mrecord", "fillcolor": null, "fontcolor": null, "attributes": [["updated_at", "Timestamp without time zone"], ["done_at", "Timestamp without time zone"], ["done_by", "Character varying(255)"], ["fl_uid", "Integer"], ["source", "Character varying(255)"], ["message", "Character varying"], ["type", "Character varying(255)"], ["data", "Jsonb"], ["metadata", "Jsonb"], ["created_at", "Timestamp without time zone"], ["id", "Integer"]], "description": [] }, { "name": "Facebook::Account", "shape": "Mrecord", "fillcolor": null, "fontcolor": null, "attributes": [["id", "Integer"], ["user_id", "Integer"], ["access_token", "Text"], ["uid", "Bigint"], ["created_at", "Timestamp without time zone"], ["updated_at", "Timestamp without time zone"]], "description": [] }, { "name": "Facebook::MobileAppInstall", "shape": "Mrecord", "fillcolor": null, "fontcolor": null, "attributes": [["id", "Integer"], ["advertiser_id", "Character varying(100)"], ["application_id", "Character varying(100)"], ["created_at", "Timestamp without time zone"], ["updated_at", "Timestamp without time zone"]], "description": [] }, { "name": "Marketing::AppBanner", "shape": "Mrecord", "fillcolor": null, "fontcolor": null, "attributes": [["platform", "Integer"], ["title", "Character varying"], ["action_url", "Character varying"], ["coach", "Integer"], ["gender", "Integer"], ["starts_at", "Timestamp without time zone"], ["ends_at", "Timestamp without time zone"], ["image_file_name", "Character varying"], ["image_content_type", "Character varying"], ["image_file_size", "Integer"], ["image_updated_at", "Timestamp without time zone"], ["created_at", "Timestamp without time zone"], ["updated_at", "Timestamp without time zone"], ["locales", "Character varying"], ["translations", "Jsonb"], ["id", "Integer"]], "description": [] }, { "name": "Marketing::Campaign", "shape": "Mrecord", "fillcolor": null, "fontcolor": null, "attributes": [["translations", "Jsonb"], ["title", "Character varying"], ["text", "Character varying"], ["whats_new_text", "Character varying"], ["link_text", "Character varying"], ["link_url", "Character varying"], ["uses_button_for_link", "Boolean"], ["uses_action_button", "Boolean"], ["link_button_tracking", "Character varying"], ["close_button_tracking", "Character varying"], ["platform", "Integer"], ["gender", "Integer"], ["coach", "Integer"], ["impressions", "Integer"], ["start_date", "Timestamp without time zone"], ["end_date", "Timestamp without time zone"], ["created_at", "Timestamp without time zone"], ["updated_at", "Timestamp without time zone"], ["image_file_name", "Character varying"], ["image_content_type", "Character varying"], ["image_file_size", "Integer"], ["image_updated_at", "Timestamp without time zone"], ["theme", "Integer"], ["locales", "Character varying"], ["id", "Integer"]], "description": [] }, { "name": "Marketing::EmailConfirmation", "shape": "Mrecord", "fillcolor": null, "fontcolor": null, "attributes": [["sent_at", "Timestamp without time zone"], ["user_id", "Integer"], ["token", "Character varying"], ["id", "Integer"], ["confirmed_at", "Timestamp without time zone"], ["created_at", "Timestamp without time zone"], ["updated_at", "Timestamp without time zone"]], "description": [] }, { "name": "Marketing::UserProfile", "shape": "Mrecord", "fillcolor": null, "fontcolor": null, "attributes": [["id", "Integer"], ["marketing_campaign_id", "Integer"], ["user_id", "Integer"], ["clicked", "Integer"], ["closed", "Integer"]], "description": [] }, { "name": "Marketing::WebCampaign", "shape": "Mrecord", "fillcolor": null, "fontcolor": null, "attributes": [["updated_at", "Timestamp without time zone"], ["voucher_token", "Character varying"], ["target", "Integer"], ["starts_at", "Timestamp without time zone"], ["ends_at", "Timestamp without time zone"], ["headline", "Character varying"], ["subline", "Character varying"], ["translations", "Jsonb"], ["created_at", "Timestamp without time zone"], ["id", "Bigint"]], "description": [] }, { "name": "NotificationInfo", "shape": "Mrecord", "fillcolor": null, "fontcolor": null, "attributes": [["confirmation_delivered_by_aws_at", "Timestamp without time zone"], ["user_id", "Integer"], ["aws_bounced", "Boolean"], ["aws_bounce_info", "Character varying"], ["optivo_bounced", "Boolean"], ["optivo_bounce_info", "Character varying"], ["optivo_blacklisted", "Boolean"], ["optivo_blacklist_info", "Character varying"], ["created_at", "Timestamp without time zone"], ["updated_at", "Timestamp without time zone"], ["confirmation_sent_to_aws_at", "Timestamp without time zone"], ["id", "Integer"]], "description": [] }, { "name": "Referral::Gift", "shape": "Mrecord", "fillcolor": null, "fontcolor": null, "attributes": [["type", "Integer"], ["user_id", "Integer"], ["referral_reference_id", "Integer"], ["id", "Integer"], ["details", "Json"], ["created_at", "Timestamp without time zone"], ["updated_at", "Timestamp without time zone"]], "description": [] }, { "name": "Referral::Reference", "shape": "Mrecord", "fillcolor": null, "fontcolor": null, "attributes": [["rejected_at", "Timestamp without time zone"], ["inviter_id", "Integer"], ["invitee_id", "Integer"], ["registered_at", "Timestamp without time zone"], ["activated_at", "Timestamp without time zone"], ["created_at", "Timestamp without time zone"], ["updated_at", "Timestamp without time zone"], ["brand_type", "Character varying"], ["approved_at", "Timestamp without time zone"], ["id", "Integer"]], "description": [] }, { "name": "Status", "shape": "Mrecord", "fillcolor": null, "fontcolor": null, "attributes": [["id", "Integer"], ["user_id", "Integer"], ["values", "Json"], ["created_at", "Timestamp without time zone"], ["updated_at", "Timestamp without time zone"]], "description": [] }, { "name": "TemporaryPassword", "shape": "Mrecord", "fillcolor": null, "fontcolor": null, "attributes": [["id", "Integer"], ["user_id", "Integer"], ["password", "Character varying"], ["created_at", "Timestamp without time zone"], ["updated_at", "Timestamp without time zone"]], "description": [] }, { "name": "User", "shape": "Mrecord", "fillcolor": null, "fontcolor": null, "attributes": [["location", "Character varying"], ["email", "Character varying"], ["password_digest", "Character varying"], ["first_name", "Character varying"], ["last_name", "Character varying"], ["gender", "Integer"], ["avatar_file_name", "Character varying"], ["avatar_content_type", "Character varying"], ["avatar_file_size", "Integer"], ["avatar_updated_at", "Timestamp without time zone"], ["height", "Numeric"], ["weight", "Numeric"], ["weight_unit", "Integer"], ["height_unit", "Integer"], ["birthday", "Date"], ["email_confirmed_at", "Timestamp without time zone"], ["locale", "Character varying"], ["registration_country", "Character varying"], ["application_source", "Integer"], ["platform_source", "Integer"], ["created_at", "Timestamp without time zone"], ["updated_at", "Timestamp without time zone"], ["emails_allowed", "Boolean"], ["about", "Text"], ["measurement_system", "Integer"], ["sanitized_email", "Character varying"], ["time_zone", "Character varying"], ["id", "Integer"]], "description": [] }], "links": [{ "source": "Marketing::UserProfile", "target": "Marketing::Campaign", "arrowtail": "dot_blue", "arrowhead": "double_arrow_blue", "color": "#1c7a9b" }, { "source": "Audited::Audit", "target": "NotificationInfo", "arrowtail": "odot_blue", "arrowhead": "double_arrow_blue", "color": "#1c7a9b" }, { "source": "Referral::Reference", "target": "User", "arrowtail": "dot_dark_gray", "arrowhead": "none", "color": "#383838" }, { "source": "Audited::Audit", "target": "User", "arrowtail": "odot_blue", "arrowhead": "double_arrow_blue", "color": "#1c7a9b" }, { "source": "Audited::Audit", "target": "User", "arrowtail": "odot_blue", "arrowhead": "double_arrow_blue", "color": "#1c7a9b" }, { "source": "Facebook::Account", "target": "User", "arrowtail": "dot_light_gray", "arrowhead": "single_arrow_light_gray", "color": "#BBB" }, { "source": "NotificationInfo", "target": "User", "arrowtail": "dot_light_gray", "arrowhead": "single_arrow_light_gray", "color": "#BBB" }, { "source": "TemporaryPassword", "target": "User", "arrowtail": "dot_blue", "arrowhead": "double_arrow_blue", "color": "#1c7a9b" }, { "source": "Auth::RefreshToken", "target": "User", "arrowtail": "dot_blue", "arrowhead": "double_arrow_blue", "color": "#1c7a9b" }, { "source": "Marketing::UserProfile", "target": "User", "arrowtail": "dot_blue", "arrowhead": "double_arrow_blue", "color": "#1c7a9b" }, { "source": "Marketing::EmailConfirmation", "target": "User", "arrowtail": "dot_blue", "arrowhead": "double_arrow_blue", "color": "#1c7a9b" }] } };
